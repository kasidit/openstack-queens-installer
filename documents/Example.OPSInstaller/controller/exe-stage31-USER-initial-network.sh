...
echo "openstack subnet create --subnet-range 10.0.10.0/24 --gateway 10.0.10.11 --network provider1 --allocation-pool start=10.0.10.100,end=10.0.10.200 --dns-nameserver 8.8.4.4 provider1-v4"
