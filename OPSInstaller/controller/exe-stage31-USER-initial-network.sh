...
echo "openstack subnet create --subnet-range 10.201.0.0/24 --gateway 10.201.0.1 --network provider1 --allocation-pool start=10.201.0.100,end=10.201.0.200 --dns-nameserver 8.8.4.4 provider1-v4"
openstack subnet create --subnet-range 10.201.0.0/24 --gateway 10.201.0.1 \
 --network provider1 --allocation-pool start=10.201.0.100,end=10.201.0.200 \
...
echo "Ping 10.201.0.100"
ping -c 4 10.201.0.100
